  ...
  <div class="bg-white rounded-2xl shadow-lg hover:shadow-xl transition p-5 border border-gray-100">
    ...
    <div class="space-y-3">
      ...
      <div class="flex flex-wrap gap-2">
        ...
        <button @click="$emit('download', doc)" class="flex-1 px-3 py-2 text-sm bg-white border rounded-lg hover:bg-gray-50 inline-flex items-center justify-center gap-2">
...
defineEmits(['preview', 'sign', 'download'])
